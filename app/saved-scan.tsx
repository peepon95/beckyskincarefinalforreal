...
export default function SavedScan() {
  ...
  const loadScanData = async () => {
    try {
      ...
      const scan = scans.find((s: any) => s.unique_id === scanId);
      ...
      >
        <View style={styles.errorContainer}>
          ...
          <Text style={styles.errorText}>
            This scan could not be found. It may have been deleted.
          </Text>
          <TouchableOpacity
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.title}>{scanData.display_title}</Text>
        ...
        {scanData.photoUri && (
          <View style={styles.photoSection}>
            <Image source={{ uri: scanData.photoUri }} style={styles.photoImage} />
          </View>
        )}
